...
This module provides a small AOI type used by the orchestration layer.
It stores geometry and CRS and exposes convenience constructors for common
inputs (bounds, GeoJSON-like specs, and raster extents).
"""
