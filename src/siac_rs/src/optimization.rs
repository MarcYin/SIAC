...
// Pure grid-remap, interpolation, and Laplacian helpers have moved to
// `optimization_grid.rs`; they are registered with the Python module via
// `lib.rs` under their original names so call sites (e.g. `siac._rust_compat`)
// are unaffected.
